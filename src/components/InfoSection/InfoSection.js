...
const InfoSection = ({see}) => (
    <div className={`${style.wrapper} ${see && style.see}`}>
        ...
        <h3>Strona została zrobiona w technologii React, a kod można podejżeć na&nbsp;<a href="https://github.com/P4NTY/CV-project" target="_blank" rel="noopener noreferrer">githubie</a>.</h3>
